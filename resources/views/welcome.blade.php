...
<head>
    ...
    <title>Systemar</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('/img/diente.png') }}" rel="icon">
...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html">Systemar</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrillto" href="#about">Get Started</a></li>
                    <li><a href="{{ route('login') }}" class="nav-link scrillto">Login</a></li>
                    <li><a href="{{ route('register') }}" class="getstarted scrollto">Registrar</a></li>
                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            ...
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3757.4248221059543!2d-99.03129048577802!3d19.651873138726277!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1f26b589936bf%3A0x33260b1418d0ce9b!2sTriana%2C%20Fraccionamiento%20Real%20Verona%2C%2055767%20Ojo%20de%20Agua%2C%20M%C3%A9x.!5e0!3m2!1ses!2smx!4v1642113043098!5m2!1ses!2smx"
                        ...
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="name">Your nombre</label>
